...
function setupMicrocontrollerFiles(context, params) {
    return copyAllFiles(vscode.Uri.file(utils.sanitizeFolderPath(context.extensionPath) + "assets/default_project_files/microcontroller/"), vscode.Uri.file(params.selectedFolder.uri.fsPath), false);
}
function setupAddonFiles(context, params) {
    return copyAllFiles(vscode.Uri.file(utils.sanitizeFolderPath(context.extensionPath) + "assets/default_project_files/addon/"), vscode.Uri.file(params.selectedFolder.uri.fsPath), false);
}
